...
public final class CoreModule_ProvideCoreMovieUseCasesFactory implements Factory<CoreMovieUseCases> {
  ...
  public CoreMovieUseCases get() {
    return provideCoreMovieUseCases(favouriteMoviesRepositoryProvider.get(), dispatcherProvider.get(), favouriteMovieInterfaceProvider.get());
  }
  ...
  public static CoreModule_ProvideCoreMovieUseCasesFactory create(
      ...
      Provider<DispatcherProvider> dispatcherProvider,
      Provider<FavouriteMovieInterface> favouriteMovieInterfaceProvider) {
    return new CoreModule_ProvideCoreMovieUseCasesFactory(favouriteMoviesRepositoryProvider, dispatcherProvider, favouriteMovieInterfaceProvider);
  }
  ...
  public static CoreMovieUseCases provideCoreMovieUseCases(
    ...
    return Preconditions.checkNotNullFromProvides(CoreModule.INSTANCE.provideCoreMovieUseCases(favouriteMoviesRepository, dispatcherProvider, favouriteMovieInterface));
  }
}
