...
public final class DetailsViewModel_Factory implements Factory<DetailsViewModel> {
  ...
  public DetailsViewModel get() {
    return newInstance(movieUseCasesProvider.get(), coreMuviiUseCasesProvider.get(), dispatcherProvider.get(), savedStateHandleProvider.get());
  }
  ...
  public static DetailsViewModel_Factory create(Provider<MovieUseCases> movieUseCasesProvider,
      ...
      Provider<DispatcherProvider> dispatcherProvider,
      Provider<SavedStateHandle> savedStateHandleProvider) {
    return new DetailsViewModel_Factory(movieUseCasesProvider, coreMuviiUseCasesProvider, dispatcherProvider, savedStateHandleProvider);
  }
  ...
  public static DetailsViewModel newInstance(MovieUseCases movieUseCases,
    ...
    return new DetailsViewModel(movieUseCases, coreMuviiUseCases, dispatcherProvider, savedStateHandle);
  }
}
