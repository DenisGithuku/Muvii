...
public final class DetailsUiState {
    ...
    private final java.util.List<com.denisgithuku.core_data.domain.model.Cast> cast = null;
    ...
    java.util.List<com.denisgithuku.core_data.domain.model.Cast> cast, boolean castLoading, boolean showConfirmationDialog, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.denisgithuku.core_data.domain.model.Cast> component4() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.denisgithuku.core_data.domain.model.Cast> getCast() {
        return null;
    }
